...
namespace AdvancedAPI.Data.Migrations
{
    ...
    [Migration("20240722213835_AddLastSeenObject")]
    partial class AddLastSeenObject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvancedAPI.Data.Models.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdvancedAPI.Data.Models.User", b =>
                {
                    b.HasOne("AdvancedAPI.Data.Models.Gender", "Gender")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AdvancedAPI.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
